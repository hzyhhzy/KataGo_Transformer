...
if __name__ == "__main__":
    ...
    optional_args.add_argument('-disable-mask', help='Disable model mask handling. Required for circular-boundary CNN validation.', required=False, action='store_true')
